...
class AbstractComplianceTest(unittest.TestCase):
    ...
    #     """Smoke test to see if data object paging works."""
    #     page1 = self.dos_request('GET', '/ga4gh/dos/v1/dataobjects')
    #     page2 = self.dos_request('GET', '/ga4gh/dos/v1/dataobjects?next_page_token=' + page1['next_page_token'])
    #     self.assertNotEqual(page1['data_objects'][0], page2['data_object'][-1])

    # def test_list_data_objects_pagesize(self):
    #     """
    #     Verify that `GET /dataobjects` handles the `page_size` parameter correctly.
    #     """
    #     page_size = 7
    #     r = self.dos_request('GET', '/ga4gh/dos/v1/dataobjects?page_size=' + page_size)
    #     self.assertEqual(len(r['data_objects']), page_size)

    # def test_list_data_objects_filtering(self):
    #     pass
