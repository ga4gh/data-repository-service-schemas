...
from ga4gh.drs.test import DataObjectServiceTest, test_requires
...
class AbstractComplianceTest(DataObjectServiceTest):
    ...
    def get_random_data_object(self):
        ...
        :rtype: tuple
        """
        r = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=100))
    ...
    def test_list_data_objects_simple(self):
        ...
        """
        r = self.drs_request('GET', '/dataobjects')
        self.assertTrue(r)
    ...
    def test_list_data_objects_by_alias(self):
        ...
        queried_objs = self.drs_request('GET', url)['data_objects']
    ...
    def test_list_data_objects_with_nonexist_alias(self):
        ...
        body = self.drs_request('GET', self.get_query_url('/dataobjects', alias=alias))
    ...
    def test_list_data_objects_paging(self):
        ...
        r = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=3))
        self.assertEqual(len(r['data_objects']), 3)
        r = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=7))
        ...
        both = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=2))
        self.assertEqual(len(both['data_objects']), 2)
        first = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=1))
        self.assertEqual(len(first['data_objects']), 1)
        second = self.drs_request('GET', self.get_query_url('/dataobjects', page_size=1,
    ...
    def test_get_data_object(self):
        ...
        data_obj_2 = self.drs_request('GET', url)['data_object']
    ...
    def test_get_data_bundle(self):
        ...
        data_bdl_2 = self.drs_request('GET', url)['data_bundle']
    ...
    def test_get_nonexistent_data_bundle(self):
        ...
        self.drs_request('GET', '/databundles/NonexistentDataBundle',
    ...
    def test_update_nonexistent_data_object(self):
        ...
        """
        obj, url = self.get_random_data_object()
        self.drs_request('PUT', '/dataobjects/NonexistentObjID', expected_status=404,
    ...
    def test_alias_update(self):
        ...
        self.drs_request('PUT', url, body={'data_object': data_object})
    ...
    def test_full_data_object_update(self):
        ...
        attributes = {
            ...
            # See DataBiosphere/drs-azul-lambda#87
        ...
        get_response = self.drs_request('GET', url)['data_object']
