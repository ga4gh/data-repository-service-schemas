...
| **release 1.6.0**: The 1.6.0 release of DRS adds optional write and lifecycle operations, including object upload and registration, deletion, checksum addition, fetching objects by checksum, and access method updates, each advertised through `/service-info` capability flags so that read access remains the only behaviour required of an implementation. | [HTML](https://ga4gh.github.io/data-repository-service-schemas/preview/release/drs-1.6.0/docs/) | [Swagger Editor](https://editor.swagger.io?url=https://ga4gh.github.io/data-repository-service-schemas/preview/release/drs-1.6.0/openapi.yaml) |
