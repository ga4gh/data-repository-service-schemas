...
For convenience, we will define a recommended syntax for fully referencing DRS-accessible objects.
This will be done in a future release with the design being discussed in [DRS#252](https://github.com/ga4gh/data-repository-service-schemas/issues/252).
